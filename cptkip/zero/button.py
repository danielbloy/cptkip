...
def create_button_pin() -> InputPin:
    """
    Simple utility function to make it easy to create a Button InputPin based on configuration.
    """
    return InputPin(config.BUTTON_PIN, config.BUTTON_PULLUP)
