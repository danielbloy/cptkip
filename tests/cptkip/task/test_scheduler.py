...
from cptkip.task.control import SCHEDULER_DEFAULT_FREQUENCY, ASYNC_LOOP_SLEEP_INTERVAL
from cptkip.task.scheduler import never_terminate, terminate_on_cancel, new_scheduled_task, new_loop_task, \
...
class TestOneTimeOnOffTask:
    ...
    def test_when_off_and_finish_events_provided(self) -> None:
        ...
        on_off_task = (
            new_one_time_on_off_task(5, lambda: 0.01, lambda: 0.01, off=off_task, finish=finish_task))
